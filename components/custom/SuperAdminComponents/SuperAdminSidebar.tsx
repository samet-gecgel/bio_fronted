...
export const SuperAdminSidebar = () => {
  ...
  const menuItems = [
    { href: "/super-admin", icon: FaTachometerAlt, text: "Genel" },
    { href: "/super-admin/admin", icon: FaUserShield, text: "Adminler" },
    { href: "/super-admin/news", icon: FaNewspaper, text: "Haberler" },
    { href: "/super-admin/users", icon: FaUsers, text: "Kullanıcılar" },
    { href: "/super-admin/companies", icon: FaBuilding, text: "Şirketler" },
    { href: "/super-admin/job-posts", icon: FaBriefcase, text: "İş İlanları" },
    { href: "/super-admin/settings", icon: FaCog, text: "Ayarlar" },
  ];
  ...
  return (
    <>
      ...
      <div className="hidden md:flex flex-col bg-white h-screen overflow-y-hidden w-64 border-r border-gray-200">
        <div className="text-black font-semibold p-4">Süper Yönetici Paneli</div>
